...
export const appRoutes: Route[] = [
    ...
    // Admin routes
    {
        ...
        children: [
            { path: 'overview', loadChildren: () => import('app/modules/overview/overview.module').then(m => m.OverviewModule) },
            { path: 'station', loadChildren: () => import('app/modules/analytics/analytics.module').then(m => m.AnalyticsModule) }, // Path changed from analytics to station
